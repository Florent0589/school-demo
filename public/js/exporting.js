...
(function (h) {
    ...
    (function (f) {
        ...
        t(h.lang, {
            ...
            contextButtonTitle: "Download this Chart"
        });
        h.navigation = {
            buttonOptions: {
                theme: {},
        ...
        p(!0, h.navigation, {
            menuStyle: {border: "1px solid #999999", background: "rgba(25,25,25,0.7)", padding: "5px 0"},
            menuItemStyle: {
                padding: "0.5em 1em",
                background: "none",
                color: "white",
            ...
            buttonOptions: {
                ...
                symbolStroke: "#ffffff",
                symbolStrokeWidth: 3,
                theme: {fill: "transparent", stroke: "none", padding: 5}
            }
        });
        h.exporting = {
            type: "image/png",
